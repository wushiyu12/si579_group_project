      ...
      <div className="row g-4">
        <div className="col-md-4">
          <ViewLogo 
            ...
            address='listView'
            iconContent={<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
        ...
        <div className="col-md-4">
          <ViewLogo 
            ...
            iconContent={<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-calendar-week" viewBox="0 0 16 16">
        ...
        <div className="col-md-4">
          <ViewLogo 
            ...
            address='mapView' 
            iconContent={<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
